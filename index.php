...
<!-- header -->
<header>
        <img src="img/slide-03.jpg" alt="drivers">
        <article>
                <h1>FREE VIDEO LESSONS</h1>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Omnis hic cupiditate eaque alias totam
                        voluptas.</p>
                <div>
                        <a href="courses.php" class="btn">oure services</a>
                        <a href="teachers.php" class="btn btnlight">oure teacher</a>
                </div>
        </article>
</header>
...
<section class="services container py">
        <article>
                ...
                <div>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis aut facilis iste eligendi
                                fugit ea
        ...
        <article class="container">
                <form action="">
                        <div>
                                ...
                                <input type="text" placeholder="Messegas">
        ...
        <article class="wrapper">
                <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <p>
                                        Phasellus lorem enim, luctus ut velit eget, convallis egestas eros. Sed ornare
                                        ligula eget
...
<!-- map -->
<section class="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.5806411034823!2d-73.98572318475725!3d40.74925227932785!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259a9e69d16c3%3A0x7a0716652d7d9778!2zMzc5IDV0aCBBdmUsIE5ldyBZb3JrLCBOWSAxMDAxNiwg0KHRmNC10LTQuNGa0LXQvdC1INCU0YDQttCw0LLQtQ!5e0!3m2!1ssr!2srs!4v1647336134781!5m2!1ssr!2srs"
